...
def get_unique_year_month_list(final_income_df):
    ...
    # The values for 'Order Creation Date' colum is in %Y-%m-%d. Getting YYYY-MM as key helps with sorting the dates in desc order.
    ...
    # Sort in desc because I found that the latest month will always have more orders, trying to make use it as a base datafram to be expanded with earlier months.
